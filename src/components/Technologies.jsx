  ...
  return (
    <div className='flex flex-col gap-8 mt-12 items-center justify-center border-t-4 p-5'>
        ...
        <div className='flex gap-8'>
            ...
            <div className="rounded-xl border-4 border-neutral-800 p-4"><SiTailwindcss size={50} color="cyan" /></div>
            <div className="rounded-xl border-4 border-neutral-800 p-4"><SiMysql size={50} color="blue" /></div>
            <div className="rounded-xl border-4 border-neutral-800 p-4"><SiReact size={50} color="cyan" /></div>
            </div>
    </div>
  )
}
